...
//       {/* Color Picker */}
//       <div className="relative flex flex-col items-center space-y-2 p-4 rounded-xl border border-lime-500 bg-white/10 backdrop-blur-lg shadow-lg transition-all duration-300 hover:shadow-xl">
//         <p className="text-black text-lg font-semibold">🎨 Pick a Color:</p>
//         <div className="relative flex justify-center items-center">
//           {/* Outer Glow Effect */}
//           <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-purple-500 via-blue-500 to-cyan-500 blur-xl opacity-50"></div>
//           {/* Color Picker */}
//           <HexColorPicker
//             color={color}
//             onChange={setColor}
//             className="relative w-24 h-24 p-2 bg-white/20 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-110"
//           />
//         </div>
//       </div>
